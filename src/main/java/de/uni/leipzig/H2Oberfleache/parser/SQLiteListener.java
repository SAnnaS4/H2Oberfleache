...
public interface SQLiteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#set_row_create}.
	 * @param ctx the parse tree
	 */
	void enterSet_row_create(SQLiteParser.Set_row_createContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#set_row_create}.
	 * @param ctx the parse tree
	 */
	void exitSet_row_create(SQLiteParser.Set_row_createContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterName_of_subtable(SQLiteParser.Name_of_subtableContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#name_of_subtable}.
	 * @param ctx the parse tree
	 */
	void exitName_of_subtable(SQLiteParser.Name_of_subtableContext ctx);
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#subtable_column_name}.
	 * @param ctx the parse tree
	 */
	void enterSubtable_column_name(SQLiteParser.Subtable_column_nameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#subtable_column_name}.
	 * @param ctx the parse tree
	 */
	void exitSubtable_column_name(SQLiteParser.Subtable_column_nameContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#subtable_name}.
	 * @param ctx the parse tree
	 */
	void enterSubtable_name(SQLiteParser.Subtable_nameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SQLiteParser#subtable_name}.
	 * @param ctx the parse tree
	 */
	void exitSubtable_name(SQLiteParser.Subtable_nameContext ctx);
	/**
